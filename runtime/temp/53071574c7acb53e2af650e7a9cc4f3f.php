<?php /*a:4:{s:76:"/data/wwwroot/tool.ruyo.net/application/index/view/index/navtiveunicode.html";i:1633860764;s:62:"/data/wwwroot/tool.ruyo.net/application/index/view/header.html";i:1647761189;s:59:"/data/wwwroot/tool.ruyo.net/application/index/view/nav.html";i:1647761189;s:62:"/data/wwwroot/tool.ruyo.net/application/index/view/footer.html";i:1647767959;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1.0, minimum-scale=1.0, maximum-scale=1.0, user-scalable=no"/>
    <title><?php echo htmlentities(app('config')->get('web.navtiveunicode.title')); ?></title>
    <meta name="applicable-device" content="pc,mobile"/>
    <meta http-equiv="Cache-Control" content="no-transform"/>
    <meta http-equiv="Cache-Control" content="no-siteapp"/>
    <meta name="keywords" content="<?php echo htmlentities(app('config')->get('web.navtiveunicode.keywords')); ?>"/>
    <meta name="description" content="<?php echo htmlentities(app('config')->get('web.navtiveunicode.description')); ?>"/>
            ...
            <div class="accordion" id="accordion2">
                <div class="accordion-group">
                    <ul class="nav nav-tabs hbflag">
                        ...
                        <li role="presentation" class="active"><a href="/navtiveunicode/">Native/Unicode编码转换</a></li>
                    ...
                    <div class="panel">
                        <form id="form1" class="form-horizontal" method="post">
                            <div class="form-group">
                                <div class="col-sm-12"><textarea onmouseover="this.focus();" id="content" name="content"
                            ...
                            <div class="form-group">
                                <div class="col-sm-12 text-center">
                                    <button type="button" id="encode" class="btn btn-success"
                                            onclick="javascript:Native2Unicode();">Native转Unicode
                                    </button>
                                    <button type="button" id="decode" class="btn btn-success"
                                            onclick="javascript:Unicode2Native();">Unicode转Native
                                    </button>
                                    <span id="copyallcode" class="btn btn-default"
                                          data-clipboard-target="#result">复制结果</span><input type="button"
                                                                                            onclick="ClearAll();"
                                                                                            value="清空"
                ...
                <div class="accordion-group">
                    <div class="in collapse bs-docs-demoexample"><h4>Native/Unicode编码在线转换工具</h4>
                        <p>该工具提供Native与Unicode编码的在线转换功能。</p></div>
                </div>
