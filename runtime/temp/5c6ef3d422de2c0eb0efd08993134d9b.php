<?php /*a:4:{s:74:"/data/wwwroot/tool.ruyo.net/application/index/view/index/checkkeyword.html";i:1633957072;s:62:"/data/wwwroot/tool.ruyo.net/application/index/view/header.html";i:1647761189;s:59:"/data/wwwroot/tool.ruyo.net/application/index/view/nav.html";i:1647761189;s:62:"/data/wwwroot/tool.ruyo.net/application/index/view/footer.html";i:1647767959;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1.0, minimum-scale=1.0, maximum-scale=1.0, user-scalable=no"/>
    <title><?php echo htmlentities(app('config')->get('web.checkkeyword.title')); ?></title>
    <meta name="applicable-device" content="pc,mobile"/>
    <meta http-equiv="Cache-Control" content="no-transform"/>
    <meta http-equiv="Cache-Control" content="no-siteapp"/>
    <meta name="keywords" content="<?php echo htmlentities(app('config')->get('web.checkkeyword.keywords')); ?>"/>
    <meta name="description" content="<?php echo htmlentities(app('config')->get('web.checkkeyword.description')); ?>"/>
                    ...
                    <div class="panel">
                        <form id="form1help" class="form-horizontal" method="post">
                            <div class="form-group">
                                <div class="col-sm-6">
                                    <input class="form-control" id="txt_url" name="txt_url" type="text" value="<?php echo htmlentities($url); ?>" placeholder="输入要检测的网址，如：http://<?php echo htmlentities($_SERVER['HTTP_HOST']); ?>"/>
                                </div>

                                <div class="col-sm-3">
                                    <input class="form-control" id="txt_url" name="txt_keyword" type="text" value="<?php echo htmlentities($keyword); ?>" placeholder="输入关键词"/>
                                </div>
                            ...
                            <table class="table table-bordered table-striped">
                                ...
                                <tr>
                                    <th class="titcolor" colspan="2">
                                        网址 <?php echo htmlentities($url); ?> 检测结果
                                    </th>
                                </tr>
                                </thead>
                                <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <font color="red"><?php echo htmlentities((isset($html_strlen) && ($html_strlen !== '')?$html_strlen:'-')); ?></font> 个字符
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <font color="red"><?php echo htmlentities((isset($html_gjccd) && ($html_gjccd !== '')?$html_gjccd:'-')); ?></font> 个字符
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <font color="red"><?php echo htmlentities((isset($html_gjcsl) && ($html_gjcsl !== '')?$html_gjcsl:'0')); ?></font> 次
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <font color="red"><?php echo htmlentities((isset($html_gjczcd) && ($html_gjczcd !== '')?$html_gjczcd:'0')); ?></font> 个字符
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <font color="red"><?php echo htmlentities((isset($html_mdjgjs) && ($html_mdjgjs !== '')?$html_mdjgjs:'-')); ?></font> %
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if(isset($html_mdjgjs)): if($html_mdjgjs>8): ?>
                                                <font color="red">关键词密度&gt;2%，密度偏高</font>
                                            <?php elseif($html_mdjgjs<2): ?>
