...
<head>
    ...
    <title><?php echo htmlentities(app('config')->get('web.caiji.title')); ?></title>
    <meta name="applicable-device" content="pc,mobile"/>
    <meta http-equiv="Cache-Control" content="no-transform"/>
    <meta http-equiv="Cache-Control" content="no-siteapp"/>
    <meta name="keywords" content="<?php echo htmlentities(app('config')->get('web.caiji.keywords')); ?>" />
    <meta name="description" content="<?php echo htmlentities(app('config')->get('web.caiji.description')); ?>" />
                    ...
                    <div class="panel">
                        <form id="form1" action="" class="form-horizontal" method="post">
                            <div class="input-group mb5">
                                <input class="form-control" type="text" name="url" id="url" value="<?php echo htmlentities($url); ?>" placeholder="输入要采集的网址,需含http(s)://"/>
                                <span class="input-group-btn"><button class="btn btn-success" type="submit" id="get_remote">采集内容</button></span>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <textarea onmouseover="this.focus();" id="content" name="content" rows="17" class="form-control"><?php echo htmlentities($content); ?></textarea>
                                </div>
                            </div>
                        </form>
                    </div>
