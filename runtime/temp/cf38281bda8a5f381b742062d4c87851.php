<?php /*a:4:{s:73:"/data/wwwroot/tool.ruyo.net/application/index/view/index/checkweixin.html";i:1633963454;s:62:"/data/wwwroot/tool.ruyo.net/application/index/view/header.html";i:1647761189;s:59:"/data/wwwroot/tool.ruyo.net/application/index/view/nav.html";i:1647761189;s:62:"/data/wwwroot/tool.ruyo.net/application/index/view/footer.html";i:1647767959;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8"/>
    ...
    <title><?php echo htmlentities(app('config')->get('web.checkweixin.title')); ?></title>
    <meta name="applicable-device" content="pc,mobile"/>
    <meta http-equiv="Cache-Control" content="no-transform"/>
    <meta http-equiv="Cache-Control" content="no-siteapp"/>
    <meta name="keywords" content="<?php echo htmlentities(app('config')->get('web.checkweixin.keywords')); ?>"/>
    <meta name="description" content="<?php echo htmlentities(app('config')->get('web.checkweixin.description')); ?>"/>
                            ...
                            <div class="form-group">
                                <div class="col-sm-9">
                                    <input class="form-control" id="txt_url" name="txt_url" type="text" value=""
                                           placeholder="输入要查询的域名，如：http://<?php echo htmlentities($_SERVER['HTTP_HOST']); ?>"/>
                                </div>
