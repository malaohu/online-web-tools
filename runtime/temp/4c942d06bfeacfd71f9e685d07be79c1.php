...
<ul class="nav nav-tabs hbflag"><li role="presentation"><a href="/md5/">MD5加密工具</a></li><li role="presentation"><a href="/urlcode/">URL网址16进制加密</a></li><li role="presentation"><a href="/urlthunder/">迅雷旋风URL加解密</a></li><li role="presentation" class="active"><a href="/base64/"> Base64加密/解密</a></li><li role="presentation"><a href="/escape/">Escape加密/解密</a></li></ul><div class="panel"><form id="form1" class="form-horizontal" method="post"><div class="form-group"><div class="col-sm-12"><textarea onmouseover="this.focus();" id="content" name="content" class="form-control" rows="12" placeholder="请输入要加密的文本"></textarea></div></div><div class="form-group"><div class="col-sm-12 text-center"><input type="button" onclick="base64_encode();" id="conv" value="Base64加密" class="btn btn-success"><input type="button" onclick="base64_decode();" id="res" value="Base64解密" class="btn btn-success"><span id="copyallcode" class="btn btn-default" data-clipboard-target="#result">复制</span><input type="button" onclick="ClearAll();" value="清空" class="btn btn-default"></div></div><div class="form-group"><div class="col-sm-12"><pre><code id="result"></code></pre></div></div></form></div></div><div class="alert alert alert-success alert-dismissible"><h4>base64在线解码工具 </h4><p>base64在线解码工具为您提供base64编码,base64在线解码,base64加密解密,对字符串进行Base64格式的加密处理,对已加密Base64在线解码解密显示为明文。Base64是比较普通的在线加密算法,在解决中文乱码时,对中文进行不同方式的编码可有效避免中文乱码。本站不会记录您的任何信息,请放心使用。</p><h4 style="color: #66be8c; margin-top:20px;">Base64索引表</h4><p>Base64编码是使用64个可打印ASCII字符（A-Z、a-z、0-9、+、/）将任意字节序列数据编码成ASCII字符串，另有&ldquo;=&rdquo;符号用作后缀用途。</p><div class="panel panel-success text-center"><table class="table table-hover table-bordered table-striped"><tbody><tr><td scope="col">数值</td><td scope="col">字符</td><td scope="col">数值</td><td scope="col">字符</td><td scope="col">数值</td><td scope="col">字符</td><td scope="col">数值</td><td scope="col">字符</td></tr><tr><td>0</td><td>A</td><td>16</td><td>Q</td><td>32</td><td>g</td><td>48</td><td>w</td></tr><tr><td>1</td><td>B</td><td>17</td><td>R</td><td>33</td><td>h</td><td>49</td><td>x</td></tr><tr><td>2</td><td>C</td><td>18</td><td>S</td><td>34</td><td>i</td><td>50</td><td>y</td></tr><tr><td>3</td><td>D</td><td>19</td><td>T</td><td>35</td><td>j</td><td>51</td><td>z</td></tr><tr><td>4</td><td>E</td><td>20</td><td>U</td><td>36</td><td>k</td><td>52</td><td>0</td></tr><tr><td>5</td><td>F</td><td>21</td><td>V</td><td>37</td><td>l</td><td>53</td><td>1</td></tr><tr><td>6</td><td>G</td><td>22</td><td>W</td><td>38</td><td>m</td><td>54</td><td>2</td></tr><tr><td>7</td><td>H</td><td>23</td><td>X</td><td>39</td><td>n</td><td>55</td><td>3</td></tr><tr><td>8</td><td>I</td><td>24</td><td>Y</td><td>40</td><td>o</td><td>56</td><td>4</td></tr><tr><td>9</td><td>J</td><td>25</td><td>Z</td><td>41</td><td>p</td><td>57</td><td>5</td></tr><tr><td>10</td><td>K</td><td>26</td><td>a</td><td>42</td><td>q</td><td>58</td><td>6</td></tr><tr><td>11</td><td>L</td><td>27</td><td>b</td><td>43</td><td>r</td><td>59</td><td>7</td></tr><tr><td>12</td><td>M</td><td>28</td><td>c</td><td>44</td><td>s</td><td>60</td><td>8</td></tr><tr><td>13</td><td>N</td><td>29</td><td>d</td><td>45</td><td>t</td><td>61</td><td>9</td></tr><tr><td>14</td><td>O</td><td>30</td><td>e</td><td>46</td><td>u</td><td>62</td><td>+</td></tr><tr><td>15</td><td>P</td><td>31</td><td>f</td><td>47</td><td>v</td><td>63</td><td>/</td></tr></tbody></table></div> <p>&nbsp;&nbsp;Base64将输入字符串按字节切分，取得每个字节对应的二进制值（若不足8比特则高位补0），然后将这些二进制数值串联起来，再按照6比特一组进行切分（因为2^6=64），最后一组若不足6比特则末尾补0。将每组二进制值转换成十进制，然后在上述表格中找到对应的符号并串联起来就是Base64编码结果。</p>  <p>&nbsp;&nbsp;Base64可用于任意数据的底层二进制数据编码，以应用于只能传输ASCII字符的场合。不过最常用于文本数据的处理传输，例如在MIME格式的电子邮件中，Base64可以用来编码邮件内容，方便在不同语言计算机间传输而不乱码，注意是传输而不是显示，例如在西欧地区计算机上使用utf-8编码即可正常显示中文（安装有对应字库），但是它未必能正常传输中文，这时转换为Base64便无此顾虑。</p>  <p>Base64编码若无特别说明，通常约定非ASCII字符按照UTF-8字符集进行编码处理。</p></div> <div class="accordion-group"> </div></div></div></div></div><script src="/static/script/jquery-1.11.3.min.js" type="text/javascript"></script><script src="/static/script/bootstrap.min.js" type="text/javascript"></script><script src="/static/script/tool.js" type="text/javascript"></script><script src="/static/script/pcjs/crypto-js.js" type="text/javascript"></script><script src="/static/script/pcjs/base64csvtojson.js" type="text/javascript"></script><script src="/static/script/hightout.js"></script><script type="text/javascript">function base64_encode() {var str = CryptoJS.enc.Utf8.parse(jQuery("#content").val());var base64 = CryptoJS.enc.Base64.stringify(str);hightout(base64);}function base64_decode() {var words = CryptoJS.enc.Base64.parse(jQuery("#content").val());hightout(words.toString(CryptoJS.enc.Utf8));}</script><div class="container" id="foot-history">
    <div class="row">
