<?php /*a:4:{s:69:"/data/wwwroot/tool.ruyo.net/application/index/view/index/refresh.html";i:1633938428;s:62:"/data/wwwroot/tool.ruyo.net/application/index/view/header.html";i:1647761189;s:59:"/data/wwwroot/tool.ruyo.net/application/index/view/nav.html";i:1647761189;s:62:"/data/wwwroot/tool.ruyo.net/application/index/view/footer.html";i:1647767959;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8"/>
    ...
    <title><?php echo htmlentities(app('config')->get('web.refresh.title')); ?></title>
    <meta name="applicable-device" content="pc,mobile"/>
    <meta http-equiv="Cache-Control" content="no-transform"/>
    <meta http-equiv="Cache-Control" content="no-siteapp"/>
    <meta name="keywords" content="<?php echo htmlentities(app('config')->get('web.refresh.keywords')); ?>"/>
    <meta name="description" content="<?php echo htmlentities(app('config')->get('web.refresh.description')); ?>"/>
            ...
            <div class="accordion" id="accordion2">
                <div class="accordion-group">
                    ...
                    <ul class="nav nav-tabs hbflag">
                        ...
                        <li role="presentation" class="active"><a href="/refresh/">在线定时刷新网址</a></li>
                        ...
                        <form id="form1" class="form-horizontal" action="" method="post">
                            <div class="form-group"><label class="col-sm-2 control-label"> 刷新网址： </label>
                                <div class="col-sm-10"><input class="form-control" id="url" name="url" type="text"
                                                              value="http://<?php echo htmlentities($_SERVER['HTTP_HOST']); ?>"
                                                              placeholder="如：http://<?php echo htmlentities($_SERVER['HTTP_HOST']); ?>" style="width: 60%;"/>
                                </div>
                            </div>
...
<script src="/static/script/pcjs/reload.js"></script>
