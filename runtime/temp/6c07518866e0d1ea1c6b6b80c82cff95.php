...
<head>
    ...
    <title><?php echo htmlentities(app('config')->get('web.chameta.title')); ?></title>
    <meta name="applicable-device" content="pc,mobile"/>
    <meta http-equiv="Cache-Control" content="no-transform"/>
    <meta http-equiv="Cache-Control" content="no-siteapp"/>
    <meta name="keywords" content="<?php echo htmlentities(app('config')->get('web.chameta.keywords')); ?>"/>
    <meta name="description" content="<?php echo htmlentities(app('config')->get('web.chameta.description')); ?>"/>
                    ...
                    <div class="panel">
                        <form id="form1help" class="form-horizontal" method="post">
                            <div class="form-group">
                                <div class="col-sm-9">
                                    <input class="form-control" id="txt_url" name="txt_url" type="text" value="<?php echo htmlentities($url); ?>"
                                           placeholder="输入要查询的网址，如：http://<?php echo htmlentities($_SERVER['HTTP_HOST']); ?>"/>
                                </div>
                        ...
                        <div id="metachecktb">
                            <table class="table table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if($title): ?><?php echo htmlentities($title); elseif($url): ?><font color="red">标题,获取失败</font><?php else: ?>-<?php endif; ?>
                                    </td>
                                    <td>
                                        <font color="red"><?php echo htmlentities($title_len); ?></font> 个字符
                                    </td>
                                    <td>
                                        <?php if($title_len<81): ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if($keywords): ?><?php echo htmlentities($keywords); elseif($url): ?><font color="red">关键字,获取失败</font><?php else: ?>-<?php endif; ?>
                                    </td>
                                    <td>
                                        <font color="red"><?php echo htmlentities($keywords_len); ?></font> 个字符
                                    </td>
                                    <td>
                                        <?php if($keywords_len<101): ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if($description): ?><?php echo htmlentities($description); elseif($url): ?><font color="red">内容描述,获取失败</font><?php else: ?>-<?php endif; ?>
                                    </td>
                                    <td>
                                        <font color="red"><?php echo htmlentities($description_len); ?></font> 个字符
                                    </td>
                                    <td>
                                        <?php if($description_len<201): ?>
