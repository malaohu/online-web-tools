<?php /*a:4:{s:81:"/data/wwwroot/tool.ruyo.net/application/index/view/index/lishishangdejintian.html";i:1634025938;s:62:"/data/wwwroot/tool.ruyo.net/application/index/view/header.html";i:1647761189;s:59:"/data/wwwroot/tool.ruyo.net/application/index/view/nav.html";i:1647761189;s:62:"/data/wwwroot/tool.ruyo.net/application/index/view/footer.html";i:1647767959;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8"/>
    ...
    <title><?php echo htmlentities(app('config')->get('web.lishishangdejintian.title')); ?></title>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">
                                        历史上的今天 <span class="greentag"><?php echo date('Y年m月d日'); ?></span>
                                    </h3>
                                </div>
                                <table class="table table-bordered table-striped">
                                    <?php foreach($list as $key=>$vo): ?>
                                    <tr><td><span class="lx_name"><?php echo htmlentities($vo['date']); ?></span><span class="lx_value"><?php echo htmlentities($vo['title']); ?></span></td></tr>
                                    <?php endforeach; ?>
                                </table>
                            </div>
                    </div>
                </div>
                <div class="alert alert alert-success alert-dismissible"><h4>历史今天</h4><p>今天发生在历史的那些事！</p></div>
