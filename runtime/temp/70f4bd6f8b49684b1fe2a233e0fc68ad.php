...
<head>
    ...
    <title><?php echo htmlentities(app('config')->get('web.webstatus.title')); ?></title>
    <meta name="applicable-device" content="pc,mobile"/>
    <meta http-equiv="Cache-Control" content="no-transform"/>
    <meta http-equiv="Cache-Control" content="no-siteapp"/>
    <meta name="keywords" content="<?php echo htmlentities(app('config')->get('web.webstatus.keywords')); ?>"/>
    <meta name="description" content="<?php echo htmlentities(app('config')->get('web.webstatus.description')); ?>"/>
            ...
            <div class="accordion" id="accordion2">
                <div class="accordion-group">
                    <ul class="nav nav-tabs hbflag">
                        ...
                        <li role="presentation" class="active"><a href="/webstatus/">HTTP状态码查询</a></li>
                    ...
                    <div class="panel">
                        <form id="form1" class="form-horizontal" method="post">
                            <div class="input-group mb5" style="width:85%"><input class="form-control" type="text"
                                                                                  name="url" id="url" value="<?php echo htmlentities($url); ?>"
                                                                                  placeholder="输入网址，如:http://<?php echo htmlentities($_SERVER['HTTP_HOST']); ?>"/><span
                                    class="input-group-btn"><button class="btn btn-success" type="submit"
                                                                    id="get_remote">查询HTTP状态</button></span></div>
                            <?php if($ip): ?>
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <table class="table table-hover table-bordered table-striped">
                                        <caption><strong>页面 <font color="#0099ff"><?php echo htmlentities($url); ?></font> 检测结果</strong></caption>
                                        <tbody>
                                        <tr>
                                            <td style="width:150px">服务器IP</td>
                                            <td><a href="/ip/<?php echo htmlentities($ip); ?>.html" target="_blank"><?php echo htmlentities($ip); ?></a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="width:150px">返回状态码</td>
                                            <td><?php echo htmlentities($code); ?></td>
                                        </tr>
                                        <tr>
                                            <td style="width:150px">网页返回HEAD信息</td>
                                            <td><?php echo $head; ?></td>
                                        </tr>
                                        </tbody>
                                    </table>
                            ...
                            <?php elseif($url): ?>
                            <div class="form-group"><div class="col-sm-12 text-left"><h3><strong style="color:#c00">网页状态检测失败,可能是域名未解析或网站无法访问</strong></h3></div></div>
                            <?php endif; ?>
                        </form>
                    </div>
                </div>
                <div class="alert alert alert-success alert-dismissible"><h4>HTTP状态查询工具</h4>
                    <p>常见的HTTP状态码</p>
                    ...
                    <p><a href="/pagecode/" target="_blank">查看所有HTTP状态码解释</a></p>
                </div>
