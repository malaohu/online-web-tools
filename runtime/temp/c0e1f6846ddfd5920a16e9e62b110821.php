...
<head>
    ...
    <title><?php echo htmlentities(app('config')->get('web.gzip.title')); ?></title>
    <meta name="applicable-device" content="pc,mobile"/>
    <meta http-equiv="Cache-Control" content="no-transform"/>
    <meta http-equiv="Cache-Control" content="no-siteapp"/>
    <meta name="keywords" content="<?php echo htmlentities(app('config')->get('web.gzip.keywords')); ?>"/>
    <meta name="description" content="<?php echo htmlentities(app('config')->get('web.gzip.description')); ?>"/>
                    ...
                    <div class="panel">
                        <form id="form1" class="form-horizontal" method="post">
                            <div class="input-group mb5">
                                <input class="form-control" type="text" name="q" id="url" value="<?php echo htmlentities($q); ?>" placeholder="输入网址"/>
                            ...
                            <div class="form-group">
                                <div class="col-sm-8">
                                    <table class="table table-hover table-bordered table-striped">
                                        ...
                                        <?php foreach($gzip['head'] as $key=>$vo): ?>
                                        <tr><td style="width:140px"><?php echo htmlentities($key); ?></td><td><?php echo htmlentities($vo); ?></td></tr>
                                        <?php endforeach; ?>
                                    </table>
                                </div>
                                <div class="col-sm-4">
                                    <table class="table table-hover table-bordered table-striped">
                                        <caption>
                                            <strong>网址 <?php echo htmlentities($url); ?> 检测结果</strong>
                                        </caption>
                                        <tr>
                                            <td style="width:140px">是否压缩</td>
                                            <td class="text-center">
                                                <strong><?php if($gzip['jc']['ystype']=='gzip'): ?><font color="green">是</font><?php else: ?><font color="red">否</font><?php endif; ?></strong>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="width:140px">压缩类型</td>
                                            <td class="text-center"><?php echo htmlentities($gzip['jc']['ystype']); ?></td>
                                        </tr>
                                        <tr>
                                            <td style="width:140px">原始文件大小</td>
                                            <td class="text-center"><?php echo htmlentities($gzip['jc']['ysize']); ?></td>
                                        </tr>
                                        <tr>
                                            <td style="width:140px">压缩后文件大小</td>
                                            <td class="text-center"><?php echo htmlentities($gzip['jc']['yssize']); ?></td>
                                        </tr>
                                        <tr>
                                            <td style="width:140px">压缩率（估计值）</td>
                                            <td class="text-center"><?php echo htmlentities($gzip['jc']['ysl']); ?> %</td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
