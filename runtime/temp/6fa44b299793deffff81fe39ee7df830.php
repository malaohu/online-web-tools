...
<ul class="nav nav-tabs hbflag"><li role="presentation"><a href="/editor/">Html在线编辑器</a></li><li role="presentation"><a href="/autoformat/"> 文章自动排版</a></li><li role="presentation"><a href="/caiji/"> 文章内容采集</a></li><li role="presentation"><a href="/jianfan/">简繁字体转换</a></li><li role="presentation"><a href="/pinyin/">汉字转为拼音</a></li><li role="presentation"><a href="/huoxingwen/">火星文转换器</a></li><li role="presentation" class="active"><a href="/textflip/">文字翻转工具</a></li><li role="presentation" class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="javascript:;" role="button" aria-haspopup="true" aria-expanded="false">更多工具<span class="caret"> </span></a><ul class="dropdown-menu"><li role="presentation"><a href="/txtreplace/">文本内容替换</a></li><li role="presentation"><a href="/textdiff/"> 文本内容对比</a></li><li role="presentation"><a href="/txtcount/">在线统计字数工具</a></li><li role="presentation"><a href="/shupai/">文字竖排工具</a></li><li role="presentation"><a href="/quchong/">内容去重工具</a></li><li role="presentation"><a href="/wenzitexiao/">文字特效工具</a></li><li role="presentation"><a href="/zipstringtext/">字符串文本压缩工具</a></li><li role="presentation"><a href="/camelcase/">驼峰与下划线互转</a></li><li role="presentation"><a href="/quanbaojiao/">全角半角转换</a></li><li role="presentation"><a href="/hexrgb/"> RGB颜色在线转换</a></li></ul></li></ul><div class="panel"><form id="mform" class="form-horizontal" method="post"><div class="form-group"><div class="col-sm-12"><textarea onmouseover="this.focus();" id="content" name="content" class="form-control" rows="10" placeholder="请输入要转换的文字"></textarea></div></div><div class="form-group"><div class="col-sm-12 text-center"><input type="button" onclick="textflip();" value="翻转文字" class="btn btn-success" /><span id="copyallcode" class="btn btn-default" data-clipboard-target="#result">复制</span><input type="button" onclick="ClearAll();" value="清空" class="btn btn-default"></div></div><div class="form-group"><div class="col-sm-12"><pre><code id="result"></code></pre></div></div></form></div></div><div class="alert alert alert-success alert-dismissible"><h4>在线文本翻转顺序工具 </h4><p>在线文本翻转顺序工具为您提供文本内容在线倒序翻转排列,针对文本内容进行在线翻转排序的功能,支持中英文字,文字倒序排列工具,将一段文字逆序排列,每行倒序或者全文倒序均可,支持中英文混排,对字符串/文本进行倒序排列,对其进行从右到左输出。</p></div> <div class="accordion-group"> </div></div></div></div></div><script src="/static/script/jquery-1.11.3.min.js" type="text/javascript"></script><script src="/static/script/bootstrap.min.js" type="text/javascript"></script><script src="/static/script/tool.js" type="text/javascript"></script><script src="/static/script/pcjs/textflip.js"></script><script src="/static/script/hightout.js"></script><div class="container" id="foot-history">
    <div class="row">
