<?php /*a:5:{s:71:"/data/wwwroot/tool.ruyo.net/application/index/view/index/regexcode.html";i:1633603258;s:62:"/data/wwwroot/tool.ruyo.net/application/index/view/header.html";i:1647761189;s:59:"/data/wwwroot/tool.ruyo.net/application/index/view/nav.html";i:1647761189;s:60:"/data/wwwroot/tool.ruyo.net/application/index/view/link.html";i:1647760721;s:62:"/data/wwwroot/tool.ruyo.net/application/index/view/footer.html";i:1647767959;}*/ ?>
<!DOCTYPE html><html lang="zh-CN"><head><meta charset="utf-8" /><meta name="viewport" content="width=device-width, initial-scale=1.0, minimum-scale=1.0, maximum-scale=1.0, user-scalable=no" /><title><?php echo htmlentities(app('config')->get('web.regexcode.title')); ?></title><meta name="applicable-device" content="pc,mobile" /><meta http-equiv="Cache-Control" content="no-transform" /><meta http-equiv="Cache-Control" content="no-siteapp" /><meta name="keywords" content="<?php echo htmlentities(app('config')->get('web.regexcode.keywords')); ?>" /><meta name="description" content="<?php echo htmlentities(app('config')->get('web.regexcode.description')); ?>" /><meta name="renderer" content="webkit" /><meta name="apple-mobile-web-app-capable" content="yes" /><link rel="icon" href="/favicon.ico" mce_href="/favicon.ico" type="image/x-icon" /><link href="/static/style/bootstrap.min.css" rel="stylesheet" type="text/css" /><link href="/static/style/tool.css" rel="stylesheet" type="text/css" /><!--[if lt IE 9]><script src="http://apps.bdimg.com/libs/html5shiv/3.7/html5shiv.min.js"></script><script src="http://apps.bdimg.com/libs/respond.js/1.4.2/respond.min.js"></script><![endif]--><?php echo app('config')->get('web.header'); ?></head><body><div class="navbar navbar-default navbar-static-top navbar-fixed-top">
...
<ul class="nav nav-tabs hbflag"><li role="presentation"><a href="/regex/">正则表达式测试工具</a></li><li role="presentation" class="active"><a href="/regexcode/">正则生成代码</a></li><li role="presentation"><a href="/formatfilter/">Html过滤工具</a></li><li role="presentation"><a href="/regexdso/">常用正则表达式</a></li><li role="presentation"><a href="/regexsucha/">正则表达式语法速查</a></li><li role="presentation"><a href="/runjs/">运行Js/html/css</a></li><li role="presentation"><a href="/xpath/">Xpath工具</a></li></ul><div class="alert alert-success alert-dismissible" role="alert">正则表达式在线代码生成工具（支持语言：JS、PHP、Golang、Java、Ruby、Python、C#）</div><div class="panel"><form id="form1" class="form-horizontal" method="post">                <div class="form-group">
                ...
                </div><div class="form-group"><div class="col-sm-12"><input class="form-control" id="searchText" name="searchText" type="text" value="" placeholder="请输入自定义正则表达式 例如：\d{6}"></div></div><div class="form-group"><div class="col-sm-12"><select class="form-control" id="sllanguagelist" name="txt_httptype"><option value="">选择要生成的语言</option><option value="javascript">JS代码</option><option value="php">PHP代码</option><option value="go">Golang代码</option><option value="java">Java代码</option><option value="rb">Ruby代码</option><option value="python">Python代码</option><option value="csharp">C#代码</option></select></div></div><div class="form-group"><div class="col-sm-12 text-center"><input type="button" onclick="return GetCode();" value="在线生成代码" class="btn btn-success"><span id="copyallcode" class="btn btn-default" data-clipboard-target="#result">复制</span><input type="button" onclick="Empty();" value="清空" class="btn btn-default"></div></div><div class="form-group"><div class="col-sm-12"><pre><code id="result"></code></pre></div></div></form></div></div></div><div class="alert alert alert-success alert-dismissible"><h4>正则表达式在线代码生成工具介绍</h4><p>正则表达式在线代码生成工具为您提供在线生成程序与JS,PHP,Golang,Java,Ruby,Python,C#的正则表达式代码。</p></div> <div class="accordion-group"> </div></div></div></div><script src="/static/script/jquery-1.11.3.min.js" type="text/javascript"></script><script src="/static/script/bootstrap.min.js" type="text/javascript"></script><script src="/static/script/tool.js" type="text/javascript"></script><script src="/static/script/pcjs/regexcode.js" type="text/javascript"></script><script src="/static/script/hightout.js"></script><div class="container" id="foot-history">
    <div class="row">
